...
"[project]/agrogebeya/frontend/app/dashboard/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Dashboard() {
    ...
    const { user, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$agrogebeya$2f$frontend$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$agrogebeya$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            if (loading) return;
            if (!user) {
...
_s(Dashboard, "ECuTCuyBzuCScSXDCsKsZ4/7zwU=", false, function() {
    return [
...
//# sourceMappingURL=agrogebeya_frontend_1fb257ff._.js.map