...
"[project]/agrogebeya/frontend/app/auth/logout/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$agrogebeya$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LogoutPage.useEffect": ()=>{
            const timer = setTimeout({
                "LogoutPage.useEffect.timer": ()=>{
                    localStorage.removeItem('user');
                    localStorage.removeItem('authToken');
                    localStorage.removeItem('rememberMe');
                    router.push('/');
                }
            }["LogoutPage.useEffect.timer"], 2000);
            return ({
                "LogoutPage.useEffect": ()=>clearTimeout(timer)
            })["LogoutPage.useEffect"];
        }
    }["LogoutPage.useEffect"], [
        router
...
//# sourceMappingURL=agrogebeya_frontend_4132c429._.js.map